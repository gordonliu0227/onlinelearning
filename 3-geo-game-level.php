  ...
  <body>
    <div id="navigation">
      ...
      <div class="head-content">
        <h1>Choose the match game level where you start<br> learning today.</h1>
      </div>
    ...
    <main>
      ...
      <div class="Content-main" id="Art-mission">
          ...
          <form class="Game-intro" id="game-1" action="match_geo-France.html">
                <input type="image" src="images/game-level/u25.png" style="height: 24vw;"> 
          </form>

          <form class="Game-intro" id="game-2" action="match_geo-America.html">
            <input type="image" src="images/game-level/u26.png" style="height: 24vw;"> 
          </form>

          
          <form class="Game-intro" id="game-3" action="match_geo-Japan.html">
