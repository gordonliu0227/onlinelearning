...
<html lang="en">
  ...
  <body>
    <div id="navigation">
      ...
      <a href="geographic.php" style="color: black; margin-left: 5vw;">Back</a>

      <div class="head-content">
        <h1>Choose the drag game level where you start<br> learning today.</h1>
      </div>
    ...
    <main>
      ...
      <div class="Content-main" id="Art-mission">
          ...
          <form class="Game-intro" id="game-1" action="drag_geo-EU.html">
                <input type="image" src="images/level 4-1-14.png" style="width: 18vw; height: 18vw;"> 
          </form>

          <form class="Game-intro" id="game-2" action="drag_geo-ASIAN.html">
            <input type="image" src="images/level 4-2-14.png" style="width: 18vw; height: 18vw;"> 
          </form>

          
          <form class="Game-intro" id="game-3" action="drag_geo-SA.html">
              <input type="image" src="images/level4-3-14.png" style="width: 18vw; height: 18vw;"> 
          </form>
