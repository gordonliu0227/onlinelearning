  ...
  <body>
    ...
    <main>
      ...
      <div class="Content-main" id="Art-mission">
        ...
        <form class="Game-intro" id="game-1" action="sci_drag_demo.html">
          <input type="image" src="images/game-level/u25.png" style="height: 24vw;"> 
        </form>

        <form class="Game-intro" id="game-2" action="sci_select_demo.html">
          <input type="image" src="images/game-level/u26.png" style="height: 24vw;"> 
        </form>

    
        <form class="Game-intro" id="game-3" action="sci_match_demo.html">
