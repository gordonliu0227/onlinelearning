...
<?php 
    if ($_GET['action']== "increase") {
        ...
        $query = "UPDATE User set art=art+1 where username = '$username' ";
...
<html lang="en">
  <head>
      ...
      />
      <link rel="stylesheet" href="gamepagecss/art.css">
  ...
  <body>
    <div id="navigation">
      ...
      <div class="head-content">
        <h1>Expand your artistic  <br>knowledge</h1>
        <p>Enhance cultural awareness and learn <br>more about different types of art.</p>
    </div>
    ...
    <section class="middle-content">
        ...
        <div class="left-middle">
            <h1>
              ...
              $art = "select art from User where username='$username'";
              $res_score = mysqli_query($con, $art);
              $score = mysqli_fetch_assoc($res_score);
              $percentage = (int)$score["art"] / 5 * 100;
            ...
            <p>
              ...
              } elseif ($score["art"]=="3"||$score["art"]=="4") {
    ...
    <main>
      ...
      <div class="Content-main" id="Art-mission">
          <div class="Game-intro" id="game-1">
              ...
              <a href="1-art-game-level.php" style=" text-decoration:none; color: white;"><button>play</button></a>  
          </div>
          ...
          <div class="Game-intro" id="game-2">
              ...
              <h2>
                ...
                <a href="2-art-game-level.php" style=" text-decoration:none; color: white;"><button>play</button></a>
          </div>
          ...
          <div class="Game-intro" id="game-3">
              ...
              <a href="3-art-game-level.php" style=" text-decoration:none; color: white;"><button>play</button></a> 
          </div>
      </div>
    </main>  
