...
<html lang="en">
  <head>
      ...
      />
      <link rel="stylesheet" href="gamepagecss/geographic.css">
  ...
  <body>
    <div id="navigation">
      ...
      <div class="head-content">
        <h1>Approach the world in a <br>happy way</h1>
        <p>Understand the history and thoughts of<br> geography, understand natural and<br> environmental geography, and connect it<br> with human activities</p>
      </div>
    </div>
    ...
    <section class="middle-content">
        ...
        <div class="left-middle">
            <h1>
              ...
              $geography = "select geography from User where username='$username'";
              $res_score = mysqli_query($con, $geography);
              $score = mysqli_fetch_assoc($res_score);
              $percentage = (int)$score["geography"] / 5 * 100;
            ...
            <p>
              <?php
              if ($score["geography"]<"3") {
                echo "You still need to study hard!";
              } elseif ($score["geography"]=="3"||$score["geography"]=="4") {
                echo "Victory is here! You are almost successful!";
              } elseif ($score["geography"]=="5") {
    ...
    <main>
      ...
      <div class="Content-main" id="Art-mission">
          <div class="Game-intro" id="game-1">
              <img src="images/Map Browsing.png" alt="game">
              <h2>
               FLAG MATCH
              </h2>
              <a href="1-geo-game-level.php" style=" text-decoration:none; color: white;"><button>play</button></a> 
          </div>

          <div class="Game-intro" id="game-2">
            <img src="images/Global Cinema.png" alt="game">
              <h2>
                GLOBAL CINEMA
              </h2>
              
              <a href="2-geo-game-level.php" style=" text-decoration:none; color: white;"><button>play</button></a>  
          </div>

          <div class="Game-intro" id="game-3">
             <img src="images/Flag match.png" alt="game">
              <h2>
                MAP BROWSING
              </h2>
              
              <a href="3-geo-game-level.php" style=" text-decoration:none; color: white;"><button>play</button></a> 
