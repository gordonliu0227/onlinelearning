  ...
  <body>
    ...
    <main>
      ...
      <div class="Content-main" id="Art-mission">
           ...
           <form class="Game-intro" id="game-1" action="match_math.html">
                  <input type="image" src="images/23.png" style="height: 18vw;margin-top:1vw;"> 
            </form>

            <form class="Game-intro" id="game-2" action="match_math2.html">
              <input type="image" src="images/38.png" style="height: 18vw; "> 
            </form>

            
            <form class="Game-intro" id="game-3" action="match_math3.html">
                <input type="image" src="images/66.png" style="height: 18vw;"> 
            </form>
