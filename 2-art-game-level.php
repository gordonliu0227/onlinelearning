  ...
  <body>
    <div id="navigation">
      ...
      >
          <a class="navbar-brand" href="#">
              <img src="images/game-level/logo.png" width="248" height="65" alt="" loading="lazy" />
          </a>
      ...
      <div class="head-content">
        <h1>Choose the game level where you start<br> learning today.</h1>
      </div>
    ...
    <main>
      ...
      <div class="Content-main" id="Art-mission">
        ...
        <form class="Game-intro" id="game-1" action="art_drag_demo.html">
          <input type="image" src="images/game-level/u25.png" style="height: 24vw;"> 
        </form>

        <form class="Game-intro" id="game-2" action="art_select_demo.html">
          <input type="image" src="images/game-level/u26.png" style="height: 24vw;"> 
        </form>

    
        <form class="Game-intro" id="game-3" action="art_match_demo.html">
            <input type="image" src="images/game-level/u27.png" style="height: 24vw;"> 
        </form>
