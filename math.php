...
<?php 
    if ($_GET['action']== "increase") {
        ...
        $query = "UPDATE User set math=math+1 where username = '$username' ";
...
<html lang="en">
  <head>
      ...
      />
      <link rel="stylesheet" href="gamepagecss/math.css">
  ...
  <body>
    <div id="navigation">
      ...
      <div class="head-content">
        <h1>Help you learn more <br>mathematics</h1>
        <p>Fluency with processes, and are able to <br>pose and solve problems and reason in<br> Number and Algebra.</p>
      </div>
    </div>
    ...
    <section class="middle-content">
        ...
        <div class="left-middle">
            <h1>
              ...
              $math = "select math from User where username='$username'";
              $res_score = mysqli_query($con, $math);
              $score = mysqli_fetch_assoc($res_score);
              $percentage = (int)$score["math"] / 5 * 100;
            ...
            <p>
              ...
              } elseif ($score["math"]=="3"||$score["math"]=="4") {
    ...
    <main>
      ...
      <div class="Content-main" id="Art-mission">
          <div class="Game-intro" id="game-1">
              <img src="images/odd and even.png" alt="game">
              <h2>
              ODD AND EVEN
              </h2>
              <a href="1-math-game-level.php" style=" text-decoration:none; color: white;"><button>play</button></a>
          </div>

          <div class="Game-intro" id="game-2">
              <img src="images/calculator.png" alt="game">
              <h2>
              CALCULATER
              </h2>
              <a href="2-math-game-level.php" style=" text-decoration:none; color: white;"><button>play</button></a> 
          </div>

          <div class="Game-intro" id="game-3">
              <img src="images/Find Partners.png" alt="game">
              <h2>
              FIND PARTNERS
              </h2>
              <a href="3-math-game-level.php" style=" text-decoration:none; color: white;"><button>play</button></a>  
          </div>
      </div>
    </main>  
